...
if ($id) {
    $sql = "SELECT * FROM user_list_2 WHERE id='$id'";
                    ...
                    <div class="card-body">
                        <form action="javascript:void(0)" method="POST" id="myform" enctype="multipart/form-data">
                            <div class="uploadIcon d-flex justify-content-center">
                                <img class="img-thumbnail imgUpload" src="<?php echo (isset($data['file_name']) && $data['file_name'] ? "./profile-img/".$data['file_name'] : "./profile-img/balnk-avtar.jpg")?>" height="200px"
                            ...
                            <input type="hidden" name="old_img" id="old_img" value="<?php echo $data['file_name']?>">
